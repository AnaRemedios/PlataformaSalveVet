    ...
    <div className="flex h-screen justify-center items-center bg-gray-50">
      <div className="flex bg-white rounded-lg shadow-lg w-full max-w-4xl">
        ...
        <div className="hidden md:flex flex-col items-center justify-center w-1/2 p-8">
          <Image
            src="/images/vet1.png" // Substitua pelo caminho correto da imagem
          ...
          />
          <Image
            src="/images/vet2.png" // Substitua pelo caminho correto da imagem
        ...
        <div className="flex flex-col justify-center items-center w-full md:w-1/2 p-8">
          ...
          <form onSubmit={handleSubmit} className="w-full max-w-sm">
            ...
            <div className="mb-6">
              <label htmlFor="crmv" className="block text-sm font-medium text-gray-700 mb-2">
                CRMV - MG
              </label>
              <input
                type="text"
          ...
          <Link href="/cadastro">
            <a className="text-center text-sm text-green-500 hover:underline">Sou Tutor</a>
          </Link>
        </div>
      </div>
    </div>
